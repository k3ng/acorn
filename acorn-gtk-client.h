...
#define CONTROL_CONNECTION_INIT_TIMEOUT_MS 5000
#define CONTROL_CONNECTION_RETRY_TIME_MS 3000
#define CONTROL_CONNECTION_SEND_DATA_ERRORS_RESET 1
#define CONTROL_CONNECTION_SEND_KEEPALIVE_MS 30000
